...
/* harmony import */ var _price_table_child__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./price-table-child */ "./src/price-table-child/index.js");
...
function Edit(_ref) {
  ...
  const blockPropsFlex = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: "flex justify-center items-start"
  });
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)(blockPropsFlex, {
    allowedBlocks: ["tailwind-wp-starter-code/price-table-child"],
    template: [["tailwind-wp-starter-code/price-table-child"]],
    templateLock: false,
    orientation: "horizontal"
  });
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", innerBlocksProps)));
}
...
function Save(_ref) {
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save();
  const blockPropsFlex = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
    className: "flex justify-center items-center"
  });
  const innerBlocksProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useInnerBlocksProps.save(blockPropsFlex);
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"tailwind-wp-starter-code/price-table","version":"0.1.0","title":"Price Table","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","supports":{"html":false},"textdomain":"price-table","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/* harmony import */ var _arritubes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./arritubes */ "./src/arritubes.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  attributes: _arritubes__WEBPACK_IMPORTED_MODULE_5__["default"],
  edit: props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_edit__WEBPACK_IMPORTED_MODULE_2__["default"], props),
